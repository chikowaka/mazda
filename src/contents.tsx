...
chrome.runtime.onMessage.addListener(function(msg, sender, sendResponse) {
  // 表示言語「英語」だと `'div[aria-label="Timeline: Your Home Timeline"]'` になるっぽい
  ...
  new_tweet_text.className = 'css-901oao css-16my406 r-1tl8opc r-bcqeeo r-qvutc0';
  ...
  new_tweet_text.innerHTML = '<b>いつでもブレスト</b>'+ '<br>' + 'ブレストタイム！あなたのお題は◯◯です' + profileTweet_action_html;
  ...
  new_profile_img.innerHTML = '<div class="r-1p0dtai r-1pi2tsx r-1d2f490 r-u8s1d r-ipm5af r-13qz1uu"><div aria-label="" class="css-1dbjc4n r-sdzlij r-1p0dtai r-1mlwlqe r-1d2f490 r-1udh08x r-u8s1d r-zchlnj r-ipm5af r-417010"><div class="css-1dbjc4n r-1niwhzg r-vvn4in r-u6sd8q r-4gszlv r-1p0dtai r-1pi2tsx r-1d2f490 r-u8s1d r-zchlnj r-ipm5af r-13qz1uu r-1wyyakw" style="background-image: url(&quot;https://pbs.twimg.com/profile_images/1166895613427900417/7p3QS01J_normal.png&quot;);"></div><img alt="" draggable="true" src="https://pbs.twimg.com/profile_images/1166895613427900417/7p3QS01J_normal.png" class="css-9pa8cd"></div></div>';
  console.log(target_profile_img.item(4));
